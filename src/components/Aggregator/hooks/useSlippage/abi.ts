export const abi = [
	{
		inputs: [
			...
			{ internalType: 'contract IClipperExchangeInterface', name: '_clipperExchange', type: 'address' }
		],
		...
		inputs: [
			{
				components: [
					...
					{ internalType: 'contract IERC20', name: 'makerAsset', type: 'address' },
					{ internalType: 'contract IERC20', name: 'takerAsset', type: 'address' },
